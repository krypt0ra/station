...
class Klinger_oscillator(IndicatorUtils):
    def analyze(self, historical_data, ema_short_period, ema_long_period,
                signal_period, signal=['kvo, kvo_signal'], hot_thresh=None, cold_thresh=None):
        ...
        for index in range(1, klinger_values.shape[0]):
            # might want to change mean index-1 to longer period and not just
            # last candle ##
