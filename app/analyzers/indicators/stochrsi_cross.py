...
class StochRSICross(IndicatorUtils):
    ...
    def analyze(self, historical_data, period_count=14, signal=[
                'stoch_rsi'], smooth_k=10, smooth_d=3, hot_thresh=None, cold_thresh=None):
        ...
        stoch_cross.at[stoch_cross.index[-1],
                       'is_cold'] = previous_k > previous_d and current_k < current_d
        stoch_cross.at[stoch_cross.index[-1],
                       'is_hot'] = previous_k < previous_d and current_k > current_d
